webpackJsonp([0], [, , , , , , function(t, e, n) {
    ...
    t.exports = ["Just now", ["Time sent %s second", "Time sent %s secondes"],
        ["Time sent %s minute", "Time sent %s minutes"],
        ["Time sent %s hour", "Time sent %s hours"],
        ["Time sent %s day", "Time sent %s days"],
        ["Time sent %s week", "Time sent %s weeks"],
        ["Time sent %s month", "Time sent %s months"],
        ["Time sent %s year", "Time sent %s years"]
    ]
}, function(t, e, n) {
    "use strict";
    var s = n(106),
                ...
                return c()(o.a.mark(function e() {
                    ...
                    return o.a.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return s = "https://api.gfycat.com/v1/reactions/populated?tagName=trending" + t.nextCursor, console.log(s), e.next = 4, fetch(s);
                            case 4:
        ...
        methods: {
            onSelect: function(t) {
                ...
                !0 !== this.ignoreControls && (this.ignoreControls = !0, l.a.CreateModal({
                    ...
                    e.ignoreControls = !1, "Delete this conversation" !== t.title && (e.$phoneAPI.callEvent(t.eventName, t.type), e.$router.push({
                        name: "home"
                    }))
                }))
            }
            ...
            delete: function() {
                ...
                if (-1 !== this.id) {
                    ...
                    c.a.CreateModal({
                        ...
                        t.ignoreControls = !1, "DELETE" === e.title && (t.$phoneAPI.deleteContact(t.id), history.back())
                    })
                } else history.back()
            }
        }),
            ...
            resetPhone: function(t, e) {
                ...
                if ("Cancel" !== e.title) {
                    ...
                    d.a.CreateModal({
                        ...
                        n.ignoreControls = !1, "Delete" === t.title && n.$phoneAPI.deleteALL()
                    })
                }
            }
        }),
    ...
    t.exports = {
        render: function() {
            ...
            return n("div", {
                ...
                staticClass: "bar"
            }), t._v(" "), n("label", [t._v("Name")])]), t._v(" "), n("div", {
